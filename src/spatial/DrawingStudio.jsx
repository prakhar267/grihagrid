  ...
  return <section className="drawing-studio" aria-label="Architectural drawings">
    ...
    <div hidden={view!=='drawing'}>
      ...
      <div className="ds-toolbar">
        <label>Drawing<select aria-label="Drawing sheet" value={sheet} onChange={e=>{setSheet(e.target.value);if(['structure','electrical','plumbing'].includes(e.target.value))setUnit('mm')}}><option value="plan">Active floor plan</option><option value="elevations">Four elevations</option><option value="stairs">Stair sections</option><option value="section">Building section</option><option value="structure">Structure coordination</option><option value="electrical">Electrical points</option><option value="plumbing">Plumbing runs</option></select></label>
        <label>Dimensions<select aria-label="Drawing dimension units" disabled={['structure','electrical','plumbing'].includes(sheet)} value={unit} onChange={e=>setUnit(e.target.value)}><option value="mm">Millimetres</option><option value="m">Metres</option><option value="ft">Feet / inches</option></select></label>
