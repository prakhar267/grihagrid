...
const unsavedWarning = 'Leave the spatial studio? Unsaved house brief, layout, component forms, tour or camera changes in this tab will be lost. Save your project changes or download the relevant scene and draft files first.';
...
export default function SpatialWorkspace({ projectId, onNavigate, logoutConfirmed = false }) {
  ...
  return <main className="sp-studio">
    ...
    {componentPending&&<div className="sp-mode-notice" role="status"><div><strong>Unapplied component forms</strong><p>Your entries stay in this tab. Download component forms in Structure &amp; services to keep a copy. Apply or discard them before accepting or replacing the layout. Drawings, 3D and exports show applied geometry.</p></div><button type="button" className="sp-secondary" onClick={reviewComponentForms}>Review component forms</button></div>}
