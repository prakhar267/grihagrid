...
test("release database evidence hard-gates legacy safety and proves migration data invariance", () => {
  ...
  const schemaNames = [
    ...
    "table:email_verification_tokens", "table:password_reset_tokens", "table:transactional_email_events",
    "table:account_deletion_requests", "table:account_deletion_receipts",
    "index:idx_email_verification_user_created", "index:idx_email_verification_expiry",
    "index:idx_password_reset_user_created", "index:idx_password_reset_expiry",
    "index:idx_transactional_email_idempotency", "index:idx_transactional_email_user_created",
    "index:idx_account_deletion_status_updated",
    "trigger:email_verification_token_identity_guard", "trigger:password_reset_token_identity_guard",
    "trigger:transactional_email_events_immutable",
    "index:idx_project_files_ready_created", "trigger:project_file_owner_insert_guard",
    "trigger:project_file_ready_insert_guard", "trigger:project_file_account_limit_insert_guard",
    "trigger:project_file_identity_immutable",
    "table:professional_profiles", "table:professional_review_requests", "table:professional_review_messages",
    "table:professional_review_events", "index:idx_professional_reviews_active_source",
    "index:idx_professional_reviews_owner_updated", "index:idx_professional_reviews_reviewer_updated",
    "index:idx_professional_reviews_queue", "index:idx_professional_review_messages_review_created",
    "index:idx_professional_review_events_review_created", "index:idx_professional_reviews_owner_requested",
    "trigger:professional_profile_role_guard", "trigger:professional_review_owner_guard",
    "trigger:professional_review_assignment_guard", "trigger:professional_review_source_immutable",
    "trigger:professional_review_messages_immutable_update", "trigger:professional_review_events_immutable_update",
  ].map((entry) => {
  ...
  const postInput = {
    ...
    countsPayload: d1(countsRows),
    usersPayload: d1(users.map((user) => ({
      ...user,
      auth_generation: 1,
