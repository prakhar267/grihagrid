...
for (const file of ["spatial.js", "spatial-intent.js", "spatial-viewpoints.js", "spatial-schema.js"]) copyFileSync(path.join(root, "worker", file), path.join(dist, "server", file));
